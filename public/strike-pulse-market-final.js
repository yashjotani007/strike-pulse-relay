...
function clearChart(){if(state.chart){state.chart.remove();state.chart=null}if(state.volume){state.volume.remove();state.volume=null}message('sp3-price-chart','');message('sp3-volume-chart','')}
