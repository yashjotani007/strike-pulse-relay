/* Strike Pulse root loader v6 — preserves working core + expiry + symbol selection fix */
(function(){
'use strict';
...
var selection='https://yashjotani007.github.io/strike-pulse-relay/selection-fix.js';
...
load(base,function(){load(expiry,function(){load(selection)})});
})();
